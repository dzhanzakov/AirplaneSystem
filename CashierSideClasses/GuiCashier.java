...
public class GuiCashier extends JFrame {
    ...
    private ChangeTicketValues changeTicketValues;
    ...
    public GuiCashier(Socket socket, ObjectInputStream objectInputStream, ObjectOutputStream objectOutputStream){
        try{
            ...
            changeTicketValues = new ChangeTicketValues(this);
            changeTicketValues.setVisible(false);
            add(changeTicketValues);
    ...
    public ChangeTicketValues getChangeTicketValues() {
        return changeTicketValues;
    }

    public void setChangeTicketValues(ChangeTicketValues changeTicketValues) {
        this.changeTicketValues = changeTicketValues;
    }
    ...
    public void updateTicket(Tickets t){
        try{
            PackageData packageData = new PackageData("UPDATE_TICKET");
            packageData.setTicket(t);
            objectOutputStream.writeObject(packageData);
            System.out.println("ticket packageData has been written to the stream -> " + packageData.getOperationType());
        }catch (Exception e){e.printStackTrace();}
    }
    ...
    public void deleteTicket(Tickets ticket){
        try{
            PackageData packageData = new PackageData("DELETE_TICKET");
