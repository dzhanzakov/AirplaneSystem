    ...
    public ChangeTicket(GuiCashier parent){
        ...
        actionButton.addActionListener(e -> {
            if(indexBox.getItemAt(indexBox.getSelectedIndex()) == null){
                jLabel.setText("You Can't Change Null Ticket");
            }else {
                parent.getChangeTicket().setVisible(false);
                parent.getChangeTicketValues().updateBoxes(parent.getFlights(), parent.getCities());
                parent.getChangeTicketValues().setId(indexBox.getItemAt(indexBox.getSelectedIndex()));
                parent.getChangeTicketValues().setVisible(true);
            }});
        add(actionButton);
